...
We are primarily interested in the case where $f$ is the loss function of a machine learning model, as discussed in @sec-supervised-ml.  More generally, minimisation is a fundamental problem in mathematics and physics.  We will also encounter it in fitting functions to data, and in the maximum likelihood methods (where we minimise the negative log likelihood) discussed in @sec-mle.
