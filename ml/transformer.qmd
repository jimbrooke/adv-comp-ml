...
![The seq2seq architecture](figures/seq2seq-2.png ){#fig-seq2seq-2}
...
![Example attention matrix from [@bahdanau2016neuralmachinetranslationjointly]](figures/attention-matrix.png){width=70%}
...
![Attention in a seq2seq architecture](figures/attention.png){#fig-attention}
...
![Modern scaled dot-product attention, taken from [@vaswani2023]](figures/attention-2.png){#fig-attention-2}
...
![Multi-head attention, taken from [@vaswani2023]](figures/multi-head-attention.png){#fig-multi-head-attention}
...
![Transformer architecture, taken from [@vaswani2023]](figures/transformer.png){#fig-transformer}
